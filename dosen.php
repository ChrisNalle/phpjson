...
?>
 <a href="index.php?proses=tambah">tambah</a>
 <table border="1px">
 <thead>
 <tr >
 <th>KODE</th>
 ...
 <td>
 <a href="<?php echo "index.php?proses=edit&key=".$d['key']?>">Edit</a>&nbsp;
 <a href="<?php echo "index.php?proses=hapus&key=".$d['key']?>">Hapus</a></td>
 </tr>
 <?php
 }
 ?>
